/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 265a5045c635a74085ee24ec7163ec09)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 
interface __BaseEnv_Env {
	AI: Ai;
	BOT_INFO: {"id":8627203050,"is_bot":true,"first_name":"Expense Ledger (Журнал расходов)","username":"adieliev_expense_ledger_bot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":false,"supports_guest_queries":false,"can_connect_to_business":false,"has_main_web_app":false,"has_topics_enabled":false,"allows_users_to_create_topics":false,"can_manage_bots":false,"supports_join_request_queries":false};
	BOT_TOKEN: string;
	GOOGLE_VISION_API: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_INFO" | "BOT_TOKEN" | "GOOGLE_VISION_API">> {}
}
